...
gulp.task( 'watch', function() {
    ...
    gulp.watch( [paths.dev + '/js/**/*.js', 'js/**/*.js', '!js/child-theme.js', '!js/child-theme.min.js'], ['scripts'] );
		...
		gulp.watch( ['template/assets/*.scss','template/assets/scss/*.scss'], ['styles'] );
		gulp.watch( 'template/assets/js/*.js', ['scripts'] );
...
gulp.task( 'scripts', function() {
    var scripts = [
        ...
        paths.dev + '/js/skip-link-focus-fix.js',
			  ...
			  './template/assets/js/af-forms.js',
			  './template/assets/js/general.js',
